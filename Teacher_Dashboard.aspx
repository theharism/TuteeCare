<%@ Page Title="" Language="C#" MasterPageFile="~/Teacher.Master" AutoEventWireup="true" CodeBehind="Teacher_Dashboard.aspx.cs" Inherits="WebApplication1.Teacher_Dashboard" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br /><br />
        ...
        <asp:Label ID="Label5" runat="server"  CssClass="home1" Text="Teacher ID:"></asp:Label>
        &nbsp;
