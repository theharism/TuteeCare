<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Add_Teacher.aspx.cs" Inherits="WebApplication1.Add_Teacher" %>
       ...
       <div class="align-item-center justify-content-center" style="height:100vh;">
        ...
        <asp:TextBox ID="TextBox2" runat="server" Placeholder="Enter DoB " TextMode="date" AutoComplete="off"></asp:TextBox>
         &nbsp;
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <asp:Label ID="Label8" runat="server" Text="Label">Teacher ID:</asp:Label>
         ...
         &nbsp;
        <asp:TextBox ID="TextBox8" runat="server" Placeholder="Enter Teacher ID" AutoComplete="off"></asp:TextBox>
         &nbsp;
                        </div>
                        <div>
                             <asp:Label ID="Label3" runat="server" Text="Label">Email:</asp:Label>
                            <asp:RequiredFieldValidator ControlToValidate="TextBox3" Display="Static"
        ...
        <asp:TextBox ID="TextBox3" runat="server" Placeholder="Enter Email" AutoComplete="off"></asp:TextBox>
         ...
         &nbsp;
                        ...
                        <div>
                            ...
                            <asp:RequiredFieldValidator ControlToValidate="TextBox5" Display="Static"
        ...
        &nbsp; 
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <asp:RequiredFieldValidator ControlToValidate="TextBox6" Display="Static"
        ...
        &nbsp;
                        ...
                        <div>
                            ...
                            <asp:RequiredFieldValidator ControlToValidate="TextBox7" Display="Static"
