...
{
    public partial class Teacher_Add_Course : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("TeacherOptCourse");
                ...
                if (check == 0)
                {
                    Response.Write("<script>alert('Course Already Opted');</script>");
                    TextBox1.Text = "";
                }
                else if (check == -1)
                {
                ...
                {
                    Response.Write("<script>alert('Course Opted Successfully');</script>");
                    TextBox1.Text = "";
                }
